      ...
      <div className="my-12 rounded-lg bg-slate-700">
        <div className="grid grid-cols-3 p-8">
          ...
          <div className="col-span-2 px-12">
            {/* <h1 className="text-5xl font-extrabold text-slate-200 py-6">Welcome to my portfolio</h1> */}
            <FaQuoteLeft className="text-3xl text-slate-200" />
            <p className="text-lg text-slate-300 py-4 text-justify">Hello! My name is Tirth Thoria and I am currently pursuing Masters in Computer Science at California State University, Long Beach. I am a former Advanced App Engineering Associate at Accenture.<br /><br />
