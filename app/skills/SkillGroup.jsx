function SkillTile({ title, icon }) {
    return <div className="group col-span-1 text-center bg-slate-600 md:rounded-3xl rounded-xl md:shadow-md shadow">
        ...
        <p className="text-slate-200 md:text-lg text-xs my-2">{title}</p>
    </div>
}
...
export default function SkillGroup({ skillName, skillIcon, skills }) {
    return <div className="md:my-12 my-6 bg-slate-700 md:rounded-3xl rounded-xl shadow-2xl md:py-12 py-6">
        <h1 className="md:text-4xl text-lg text-slate-200 md:font-extrabold font-bold text-center">
            {skillIcon} {skillName}
        </h1>
