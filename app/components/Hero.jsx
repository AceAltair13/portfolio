...
const Hero = () => {
    return (
        <div className='min-h-svh grid justify-around items-center grid-cols-2'>
            <div className='col-span-1 bg-gray-800 bg-opacity-85 p-10 rounded-3xl'>
                ...
                <Link href={RESUME_LINK} target="_blank" className='bg-green-500 text-slate-50 transition-colors hover:bg-green-600 px-6 py-3 rounded-full'>
                    View Resume
                </Link>
            </div>
